...
PICS = (environ.get('PICS', 'https://graph.org/file/8871a80b1f12ada38f97f-842dcb20d3e3e3bc6c.jpg https://graph.org/file/2b78903077a0393eeb76b-89458bd77ecb994473.jpg https://graph.org/file/c4efe5e79976ae64c2dc9-4370b00eb089a33bdf.jpg')).split()
...
PREMIUM_PIC = environ.get('SUBSCRIPTION', 'https://graph.org/file/39af86ca72c5e623e163d-8ff8dc6ef9752762d0.jpg')
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/a397cb059dba548be6f13-a46f23676e478fc3ef.jpg') # Scanner Code image 
...
SEND_ALL_LIMITE = int(environ.get('SEND_ALL_LIMITE', 50))
...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "dvl_naruto_06") # widout 👉 @
...
POST_CHANNELS = list(map(int, (channel.strip() for channel in environ.get('POST_CHANNELS', '-1002655119999').split(','))))
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002282783745'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002282783745'))
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'NARUTO')
...
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1002635477308)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1002635477308)) # movies request channel, else log channel
